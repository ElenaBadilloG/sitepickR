...
```{r, results='asis'}
unitBalanceTab = summary(matchOut, diagnostic="unitBal")
...
```{r, results='asis'}
matchBalanceTab = summary(matchOut, diagnostic="matchBal")
...
```{r, results='asis'}
matchCountTab = summary(matchOut, diagnostic="matchCount")
...
```{r, results='asis'}
subUnitBalanceTab = summary(matchOut, diagnostic="subunitBal")
